...
image_of_angelina = face_recognition.load_image_file('angelina.jpg')
angelina_face_encoding = face_recognition.face_encodings(image_of_angelina)[0]

image_of_chris = face_recognition.load_image_file('chris.jpg')
...
test_image = face_recognition.load_image_file('unknown_pictures/a_j2.jpg')
